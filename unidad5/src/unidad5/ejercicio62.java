...
public class ejercicio62 {
	...
	public static void main(String[] args) {
				...
				if (primparte[0].length() < 4) {
					...
					if (posicion < 0) {
						...
						if (segparte[0].length() < 3) {
							...
							if ((!segparte[1].equals("com")) && (!segparte[1].equals("es"))
									&& (!segparte[1].equals("org")) && (!segparte[1].equals("gov"))) {
		...
		case 4:
			...
			break;
		case 5:
			System.out.println("ERROR5: El identificador2 no llega a 3caracteres");
			break;
		case 6:
