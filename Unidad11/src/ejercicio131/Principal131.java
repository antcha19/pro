...
public class Principal131 {
	...
	public static void main(String[] args) {
		...
		System.out.println(plato1.consultar_ingredientes());
		...
		System.out.println(plato2.consultar_ingredientes());
		...
		System.out.println(plato3.consultar_ingredientes());
		...
		System.out.println("El restaurante ha facturado: " + reserva1 + "€.");
		
		//Al final del dia desmontamos las mesas
		//Empezamos recogiendo la mesa mesa1
